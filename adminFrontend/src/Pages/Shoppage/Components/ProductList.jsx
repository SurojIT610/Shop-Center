              ...
              <div className="product__item" onClick={() => handleProductClick(product.id)}>
                ...
                >
                  ...
                  <div className="product__item__hover">
                    <ul>
                      <li>
                        <a href="#" onClick={(e) => { e.stopPropagation(); handleAddToCart(product); }}>
            ...
            <ul className="pagination">
              <li className="page-item">
                <a
                  className="page-link"
                  href="#"
                  onClick={(e) => { e.preventDefault(); handlePageChange(currentPage > 1 ? currentPage - 1 : 1); }}
                >
              ...
              <li className="page-item">
                <a
                  className="page-link"
                  href="#"
                  onClick={(e) => { e.preventDefault(); handlePageChange(currentPage < totalPages ? currentPage + 1 : totalPages); }}
                >
